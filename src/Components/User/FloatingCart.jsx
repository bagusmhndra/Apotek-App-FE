...
import { Cart2, Trash, Plus, Dash } from 'react-bootstrap-icons';
...
const FloatingCart = ({ hideCartButton }) => {
  ...
  const hideOnPaths = ['/dashboard', '/login', '/register', '/checkout', '/forgot-password', '/reset-password', '/about-us', '/contact', '/*'];
